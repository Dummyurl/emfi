...
class Admin extends Authenticatable
{
    ...
    public static $LIST_CMS_GRAPH = 56; 
    public static $ADD_CMS_GRAPH = 57; 
    public static $EDIT_CMS_GRAPH = 58; 
    public static $DELETE_CMS_GRAPH = 59; 

    public static $LIST_CMS_GRAPH_SLIDER = 60; 
    public static $ADD_CMS_GRAPH_SLIDER = 61; 
    public static $EDIT_CMS_GRAPH_SLIDER = 62; 
