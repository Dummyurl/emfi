        ...
        var oTableCustom = $('#server-side-datatables').DataTable({
            ...
            ajax: {
                ...
                "data": function ( data ) 
                {
                    ...
                    data.search_cms = $("#search-frm select[name='search_cms']").val();
            ...
            columns: [
                { data: 'id', name: 'id' },
                { data: 'graph_name', name: 'graph_name' },
                { data: 'cms_page', name: '{{TBL_CMS_PAGES}}.title'},
                { data: 'position', name: 'position' },
                { data: 'city', name: '{{TBL_CITY}}.title' },
