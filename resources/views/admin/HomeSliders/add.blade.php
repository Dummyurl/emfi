                    ...
                    <div class="down_content" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::select('option_market',[''=>'Select Option']+$marketTypes,$selected_maturities,['class' => 'form-control','id'=>'option_market_id']) !!}
                            </div>
                        </div>
                        </div>
                        <!-- Rating -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label class="control-label">Banchmark<span class="required">*</span></label>
