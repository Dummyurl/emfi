                ...
                <div class="container">
                    <div class="slider_inner">
                        <div class="title_belt">
                          ...
                          <span>{{ __('services.inv_sub_title') }}</span>
                        </div>
                        <div class="row">
                            <div class="slider_content">
                                ...
                                <div class="col-md-6">
                                    <div class="text_right">
                                        ...
                                        <p>{{ __('services.inv_our_services_1') }}</p>
                                        <p>{{ __('services.inv_our_services_2') }}</p>
                                        <p>{{ __('services.inv_our_services_3') }}</p>
                                        <p>{{ __('services.inv_our_services_4') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="slider_content">
                                ...
                                <div class="col-md-6">
                                    <div class="text_right">
                                      ...
                                      <p>{{ __('services.inv_our_approach_1') }}</p>
                                      <p>{{ __('services.inv_our_approach_2') }}</p>
                                      <p>{{ __('services.inv_our_approach_3') }}</p>
                                      <p>{{ __('services.inv_our_approach_4') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="slider_content">
                                ...
                                <div class="col-md-6">
                                    <div class="text_right">
                                      ...
                                      <p>{{ __('services.inv_our_clients_1') }}</p>
                                      <p>{{ __('services.inv_our_clients_2') }}</p>
                                      <p>{{ __('services.inv_our_clients_3') }}</p>
                                      <p>{{ __('services.inv_our_clients_4') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="office_details">
                    <h3>LONDON</h3>
                    <address>
                        <strong>EMFI</strong> Securities Limited<br><br>
                        32 Devonshire Pl<br>
                        London, W1G 6JL<br>
                        United Kingdom
                    </address>
                    <a href="mailto:securities@emfi.eu">securities@emfi.eu</a>
              </div>
                </div>
            <div class="col-md-8">
