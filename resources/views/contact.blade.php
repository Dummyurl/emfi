        ...
        <div class="contact_form">
            <div class="row">
                ...
                <!-- <form action="{{ url('contact-form')}}" method="post" id="contact_form_id"> -->
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::text('organization', null, ['class' => 'form-control', 'placeholder' => __('contact.last_name') , 'required' => 'required']) !!}
                            <!-- <input name="last_name" class="form-control" id="" placeholder="{{ __('contact.last_name') }}" type="text" required="required"> -->
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::text('phone' , null , ['class' => 'form-control' , 'placeholder' => __('contact.country') , 'required' => 'required']) !!}
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::select('subject' , ['' => __('contact.subject')] + ['ENQUIRY' => __('header.enquiry') , 'FEEDBACK' => __('header.feedback') , 'COMPLAINT' => __('header.complaint') , 'CAREERS' => __('header.careers') , 'LOCATIONS' => __('header.locations')], null, ['class' => 'form-control' ,  'required' => 'required']) !!}
